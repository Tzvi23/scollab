...
namespace StudentCollab.Controllers
{
    public class MainPageControllerTest : Controller
    {
        ...
        //Changed to get user as argumment
        public ActionResult backToHome(User usr)
        {
            //Original
        ...
        //Modified for TESTING
        public ActionResult SyearsPage(Department dep, User usr)
        {
            if (dep != null)
            {
                SyearDal dal = new SyearDal();
        ...
        //Modified for testing
        public ActionResult ThreadsPage(Syear year, User c)
        {
            if (year != null)
            {
        ...
        public ActionResult NewThread()
        {
            ...
            return View("NewThread", cur);
        }
        //Modified for testing - Tested V
        //Add new thread to DataBase
        public ActionResult CreateNewThread(Syear year, Thread testThread, User testUser, string Content)
        {
            ...
            string newThreadName = testThread.ThreadName;
            string newContent = Content;
            string newThreadType = testThread.ThreadType;

            User curUser = testUser;
        ...
        //Modified for testing
        //Tested - V
        public ActionResult AgreemantPage(User cur)
        {
            //User cur = getUser();
            ...
            return View("AgreemantPage", cur);
        }

        //modified for testing
        //Tested - V
        public ActionResult UpdateAgreemant(Other agr, string new_content)
        {
            OtherDal val = new OtherDal();
            List<Other> agreemant =
                (from x in val.Others
